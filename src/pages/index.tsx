      ...
      <div className='flex-[3] flex justify-center'>
        ...
        >
          <h1 className='text-3xl font-bold pb-8 max-sm:text-xl'>
            Kickstart Your Fitness <br />Journey Today
          </h1>
          <p className='max-sm:text-sm'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius nam maxime deleniti dolor asperiores ea, ipsa, harum, quas iusto consequatur quisquam ab quaerat totam sapiente sit corporis nisi dicta! Doloremque, odio cumque.
          </p>
        </div>
      </div>
      <img src={bannerImg} alt="Body Fitness" className='h-[36rem] self-end flex-[2] object-contain max-sm:hidden' />
    </div>
  )
}
...
function About() {
  return (
    <div  className='py-24 flex relative'>
      <img src={aboutImg} alt="Our Company" className='
      ...
      '>
        ...
        <p className='text-lg pt-10 pb-6'>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate provident beatae laudantium quos expedita repellendus totam.
        </p>
        <Link to='/about'>
        ...
        <div className='w-1/2'>
          <ul className='pt-2 pr-12'>
            ...
            {services.map((service) => {
              ...
              return (
                <li
                  key={service.slug} className='border-b border-b-neutral-400/80'
                  id={service.slug} onMouseEnter={handleServiceHover}
                >
                  <a
                  ...
                  >
                    <div>
                      <h1 className='text-xl font-semibold text-neutral-600'>{service.name}</h1>
                      <p className='text-sm'>{service.caption}</p>
                    </div>
          ...
          <p className='pt-4 pl-6 underline underline-offset-8 text-primary'>+ more!</p>
        </div>
    ...
    >
      ...
      <div className='flex-1 flex flex-col justify-center'>
        ...
        <div className='bg-white p-4 mt-3 rounded-l-2xl shadow-xl shadow-black/20'>
          <p className='w-[24rem]'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere iusto ad doloribus officia quia, dolore est modi aliquid dolorem numquam quos quam eveniet velit?
          </p>
        </div>
      </div>
    </div>
